function trade_window() {
  ...
  if (sap_extension.settings.trade_window.api_warning) api_warning();
  if (sap_extension.settings.trade_window.trade_toolbar) trade_toolbar();
  if (sap_extension.settings.trade_window.tw_impersonator_scanner) impersonator_scanner(trade_window_data.partner);
  if (sap_extension.settings.trade_window.tw_reputation_scanner) reputation_scanner();
  else {
